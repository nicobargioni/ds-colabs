...
DEMO = {
    ...
    "acento": "a bordo del Titanic",
    "vlabels": ["Kaggle", "Clasificación", "ROC-AUC"],
    "fuentes": ["Kaggle", "datasciencedojo", "scikit-learn", "Google Colab"],
    "highlights": [
        ("Sexo y clase", "Son los predictores más fuertes: mujeres y 1ª clase concentran la mayor tasa de supervivencia.", "Hipótesis 1"),
        ("Faltantes en Age", "~20% de edades ausentes; se imputan con la mediana dentro del Pipeline.", "Preprocesamiento"),
        ("Baseline vs ensemble", "LogReg interpretable contra RandomForest; comparados por ROC-AUC en CV.", "2 modelos"),
    ],
